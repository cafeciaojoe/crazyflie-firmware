...
// offset the LH sensors x mm off from the assumed height of the LH deck. Which we assume to be around 5mm. 
// i.e the total offset is x - 5 mm
static vec3d sensorDeckPositions[4] = {
    {-SENSOR_POS_L, SENSOR_POS_W, (0.088725f - .005f)},
    {-SENSOR_POS_L, -SENSOR_POS_W, (0.088725f - .005f)},
    {SENSOR_POS_L, SENSOR_POS_W, (0.088725f - .005f)},
    {SENSOR_POS_L, -SENSOR_POS_W, (0.088725f - .005f)},
};
